...
User users[] = {{"iitjodhpur", "ankit"}, {"user1", "password1"}, {"user2", "password2"}};
...
void displayHeader()
{
    ...
    printf("\t\t\t\t\t*             1. Ankit                          *\n");
    printf("\t\t\t\t\t*             2. Harsh                          *\n");
    printf("\t\t\t\t\t*             3. Abhishek yadav                 *\n");
    printf("\t\t\t\t\t*             4. Kanishk lamba                  *\n");
    printf("\t\t\t\t\t*************************************************\n\n\n");
...
void AddNewStudent()
{
    ...
    while(!IsValidEmail)
    {
        ...
        else if(strlen(NewStudent.Email) > 40)
        {
            printf(" Error: Email can not be more than 40 characters.\n\n");
            IsValidEmail = false;
        }
    ...
    while(!IsValidPhone)
    {
        ...
        else if(strlen(NewStudent.Phone) > 12)
        {
            printf(" Error: Phone can not be more than 12 characters.\n\n");
            IsValidPhone = false;
        }
...
void EditStudent(char StudentID[10])
{
    ...
    while(!IsValidName)
    {
        ...
        if(strlen(NewStudent.Name) > 40)
        {
            printf(" Error: Name can not be more than 40 characters.\n\n");
            IsValidName = false;
        }
        if(strlen(NewStudent.Name) <= 0)
        {
